...
CMON_API cmon_idx cmon_ast_struct_field_list_type(cmon_ast * _ast, cmon_idx _idx);
CMON_API cmon_idx cmon_ast_struct_field_list_expr(cmon_ast * _ast, cmon_idx _idx);
CMON_API cmon_idx cmon_ast_struct_field_list_names_begin(cmon_ast * _ast, cmon_idx _idx);
CMON_API cmon_idx cmon_ast_struct_field_list_names_end(cmon_ast * _ast, cmon_idx _idx);
CMON_API cmon_ast_iter cmon_ast_struct_field_list_names_iter(cmon_ast * _ast, cmon_idx _idx);
