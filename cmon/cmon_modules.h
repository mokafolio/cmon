...
CMON_API cmon_idx cmon_modules_find_import(cmon_modules * _m, cmon_idx _looking_mod_idx, cmon_str_view _path);
CMON_API void cmon_modules_add_search_prefix(cmon_modules * _m, cmon_idx _mod_idx, cmon_str_view _path);
CMON_API void cmon_modules_add_search_prefix_c_str(cmon_modules * _m, cmon_idx _mod_idx, const char * _path);
CMON_API void cmon_modules_add_path_overwrite(cmon_modules * _m, cmon_idx _mod_idx, cmon_str_view _path, cmon_str_view _overwrite);
